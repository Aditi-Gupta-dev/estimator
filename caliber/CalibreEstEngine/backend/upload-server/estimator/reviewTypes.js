...
export const NotificationType = {
  ...
  ESTIMATE_REVIEW_SIGNAL: 'estimate_review_signal',
  // Phase 5
  DELTA_ANALYSIS_COMPLETED: 'delta_analysis_completed',
  DELTA_ANALYSIS_FAILED: 'delta_analysis_failed',
};
...
export const AuditAction = {
  ...
  ESTIMATE_REVIEW_SIGNAL_CREATED: 'ESTIMATE_REVIEW_SIGNAL_CREATED',
  // Phase 5 (Part 17)
  DELTA_ANALYSIS_REQUESTED: 'DELTA_ANALYSIS_REQUESTED',
  DELTA_ANALYSIS_COMPLETED: 'DELTA_ANALYSIS_COMPLETED',
  DELTA_ANALYSIS_FAILED: 'DELTA_ANALYSIS_FAILED',
};
